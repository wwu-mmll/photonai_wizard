...
cv_infos = pd.read_excel('../../assets/db_files/cross_validation.xlsx', sheet_name='Tabelle1', header=0, index_col='cv_name')
cv_hyp_infos = pd.read_excel('../../assets/db_files/cross_validation.xlsx', sheet_name='Tabelle2', header=0)
...
#           Transformer                      #
#-------------------------------------------#
trans_infos = pd.read_excel('../../assets/db_files/transformer.xlsx', sheet_name='Tabelle1', header=0,
                            index_col='transformer_name')
hyp_infos = pd.read_excel('../../assets/db_files/transformer.xlsx', sheet_name='Tabelle2', header=0)
...
for trans_name, trans_row in trans_infos.iterrows():
    ...
    inst.tags = trans_row["tags"].strip(" ").split(",")
...
est_infos = pd.read_excel('../../assets/db_files/estimator.xlsx', sheet_name='Tabelle1', header=0,
                          index_col='estimator_name')
hyp_infos = pd.read_excel('../../assets/db_files/estimator.xlsx', sheet_name='Tabelle2', header=0)
